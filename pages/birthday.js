  ...
  return (
    <div className={styles.container}>
      <h2 className={styles.title}>
        T-minus <span className={styles.days}>{days} days, </span>
        <span className={styles.hours}>{hours} hours, </span>
        <span className={styles.minutes}>{minutes} minutes, </span>and{" "}
        <span className={styles.seconds}>{seconds} seconds</span> until my
        birthday!
      </h2>
